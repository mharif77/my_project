                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-6">
                                    <div class="counter-wrap text-right">
                                        <span class="counter-cap"><i
                                                class="fa  fa-level-up txt-success"></i></span><span
                                            class="counter">15</span><span>%</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-6">
                                    <div class="counter-wrap text-right">
                                        <span class="counter-cap"><i
                                                class="fa  fa-level-up txt-success"></i></span><span
                                            class="counter">10</span><span>m</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="sm-graph-box">
                            <div class="row">
                                ...
                                <div class="col-xs-6">
                                    <div class="counter-wrap text-right">
                                        <span class="counter-cap"><i
                                                class="fa  fa-level-down txt-danger"></i></span><span
                                            class="counter">3</span><span>%</span>
                                    </div>
                                </div>
                            </div>
                        </div>
