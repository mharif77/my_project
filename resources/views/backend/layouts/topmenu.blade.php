<nav class="navbar navbar-inverse navbar-fixed-top">
				...
				<ul class="nav navbar-right top-nav pull-right">
					...
					<li class="dropdown">
						<a href="#" class="dropdown-toggle pr-0" data-toggle="dropdown"><img src="{{('dist/img/user1.png')}}" alt="Super Admin" class="user-auth-img img-circle"/><span class="user-online-status"></span></a>
