        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default card-view">
                <div class="panel-heading">
                    <div class="pull-left">
                        <h6 class="panel-title txt-dark">New purchase Form</h6>
                    </div>
                                ...
                                <div class="form-wrap">
                                    <form class="form-horizontal" method="post" action="{{route('purchase.store')}}"
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputuname_4" class="col-sm-3 control-label">item name</label>
                                            <div class="col-sm-9">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="item_name"
                                                        id="exampleInputuname_4" placeholder="Enter your item name">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="quantity"
                                                        id="exampleInputuname_4" placeholder="Enter your quantity">
                                                    <div class="input-group-addon"><i class="icon-user"></i></div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputuname_4"
                                                class="col-sm-3 control-label">purchase date</label>
                                            <div class="col-sm-9">
                                                <div class="input-group">
                                                    <input type="date" class="form-control" name="purchase_date"
                                                        id="exampleInputuname_4" placeholder="Enter your purchase date">
                                                    <div class="input-group-addon"><i class="icon-user"></i></div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputuname_4"
                                                class="col-sm-3 control-label">supplier name</label>
                                            <div class="col-sm-9">
                                                <div class="input-group">
