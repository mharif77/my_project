                                ...
                                <div class="form-wrap">
                                    <form class="form-horizontal" method="post"
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputuname_4" class="col-sm-3 control-label">supplier_name</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputuname_4"
                                                class="col-sm-3 control-label">Purchase</label>
                                            <div class="col-sm-9">
                                                <select name="purchase_id" id="" class="form-control">
                                                    ...
                                                    @foreach($purchases as $purchase)	
                                                        ...
                                                        <option value="{{$purchase->id}}" @selected(old('purchase_id') ?? $supplier->purchase_id == $purchase->id)>
